...
char* genlua_emit(emit_desc* emit, fnum_t when) {
    ...
    kstring_appendvf(s, "%g, %g, %g, %g, ", emit->x, emit->y, emit->ux, emit->uy);
    ...
    kstring_appendvf(
        s, "Vis.frames2msec(%d), Vis.frames2msec(%d), ", emit->life, emit->ulife);
    kstring_appendvf(s, "%g, %g, %g, ", (double)emit->r, (double)emit->g, (double)emit->b);
    kstring_appendvf(
        s, "%g, %g, %g, ", (double)emit->ur, (double)emit->ug, (double)emit->ub);
...
const char* genlua_force(force_id force) {
    ...
    case VIS_DEFAULT_FORCE:
        return "Vis.DEFAULT_FORCE";
    case VIS_FORCE_FRICTION:
        return "Vis.FORCE_FRICTION";
    case VIS_FORCE_GRAVITY:
        return "Vis.FORCE_GRAVITY";
    case VIS_NFORCES:
        return "Vis.NFORCES";
    default:
        return "nil";
...
const char* genlua_limit(limit_id limit) {
    ...
    case VIS_DEFAULT_LIMIT:
        return "Vis.DEFAULT_LIMIT";
    case VIS_LIMIT_BOX:
        return "Vis.LIMIT_BOX";
    case VIS_LIMIT_SPRINGBOX:
        return "Vis.LIMIT_SPRINGBOX";
    case VIS_NLIMITS:
        return "Vis.NLIMITS";
    default:
        return "nil";
...
const char* genlua_blender(blend_id blender) {
    switch (blender) {
    case VIS_BLEND_NONE:
        return "Vis.BLEND_NONE";
    /* case VIS_DEFAULT_BLEND: */
    case VIS_BLEND_LINEAR:
        return "Vis.BLEND_LINEAR";
    case VIS_BLEND_PARABOLIC:
        return "Vis.BLEND_PARABOLIC";
    case VIS_BLEND_QUADRATIC:
        return "Vis.BLEND_QUADRATIC";
    case VIS_BLEND_SINE:
        return "Vis.BLEND_SINE";
    case VIS_BLEND_NEGGAMMA:
        return "Vis.BLEND_NEGGAMMA";
    case VIS_BLEND_EASING:
        return "Vis.BLEND_EASING";
    case VIS_NBLENDS:
        return "Vis.NBLENDS";
    default:
        return "nil";
...
const char* genlua_mutate(mutate_id fnid) {
    ...
    case VIS_MUTATE_SET_FRICTION:
        return "Vis.MUTATE_SET_FRICTION";
    case VIS_MUTATE_SET_GRAVITY:
        return "Vis.MUTATE_SET_GRAVITY";
    ...
    case VIS_MUTATE_SET_FRICTION_IF:
        return "Vis.MUTATE_SET_FRICTION_IF";
    case VIS_MUTATE_SET_GRAVITY_IF:
        return "Vis.MUTATE_SET_GRAVITY_IF";
    case VIS_NMUTATES:
        return "Vis.NMUTATES";
    default:
        return "nil";
...
const char* genlua_mutate_cond(mutate_cond_id id) {
    ...
    case VIS_MUTATE_IF_TRUE:
        return "Vis.MUTATE_IF_TRUE";
    case VIS_MUTATE_IF_EQ:
        return "Vis.MUTATE_IF_EQ";
    case VIS_MUTATE_IF_NE:
        return "Vis.MUTATE_IF_NE";
    case VIS_MUTATE_IF_LT:
        return "Vis.MUTATE_IF_LT";
    case VIS_MUTATE_IF_LE:
        return "Vis.MUTATE_IF_LE";
    case VIS_MUTATE_IF_GT:
        return "Vis.MUTATE_IF_GT";
    case VIS_MUTATE_IF_GE:
        return "Vis.MUTATE_IF_GE";
