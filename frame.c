...
emit_t make_kick_frame(int n) {
    return make_emit_frame(n,
        ...
        VIS_FORCE_FRICTION, VIS_DEFAULT_LIMIT, VIS_BLEND_LINEAR);
}
...
emit_t make_snare_frame(int n) {
    return make_emit_frame(n,
        ...
        VIS_FORCE_GRAVITY, VIS_LIMIT_SPRINGBOX, VIS_BLEND_LINEAR);
}
...
emit_t make_rain_frame(int n) {
    return make_emit_frame(n,
        ...
        VIS_FORCE_GRAVITY, VIS_DEFAULT_LIMIT, VIS_BLEND_NONE);
}
*/
...
emit_t make_emit_frame(int n,
    ...
    emit_t frame = DBMALLOC(sizeof(struct emit_frame));
    frame->n = n;
    frame->x = x;
    frame->y = y;
    frame->ux = ux;
