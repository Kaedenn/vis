...
settime(TRACK_1, T1.NextSchedule())
T1.emit_circle(now(TRACK_1), W_1_4, H_1_2)
T1.emit_circle(now(TRACK_1), W_3_4, H_1_2)
settime(TRACK_1, T1.NextSchedule())

settime(TRACK_1, T1.NextSchedule())
T1.emit_circle(now(TRACK_1), W_1_3, H_2_3)
T1.emit_circle(now(TRACK_1), W_2_3, H_2_3)
settime(TRACK_1, T1.NextSchedule())

settime(TRACK_1, T1.NextSchedule())
T1.emit_circle(now(TRACK_1), W_1_4, H_3_4)
T1.emit_circle(now(TRACK_1), W_3_4, H_3_4)
settime(TRACK_1, T1.NextSchedule())

settime(TRACK_1, T1.NextSchedule())
T1.emit_circle(now(TRACK_1), W_1_3, H_5_6)
T1.emit_circle(now(TRACK_1), W_2_3, H_5_6)
settime(TRACK_1, T1.NextSchedule())
