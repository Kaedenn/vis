...
typedef enum {
    ...
    VIS_MUTATE_SET_VERTICES,
    VIS_MUTATE_SET_ANGLE,
    VIS_MUTATE_SET_FRICTION,
    VIS_MUTATE_SET_GRAVITY,
    ...
    VIS_MUTATE_SET_DZ_IF,
    VIS_MUTATE_SET_RADIUS_IF,
    VIS_MUTATE_SET_VERTICES_IF,
    VIS_MUTATE_SET_ANGLE_IF,
    VIS_MUTATE_SET_FRICTION_IF,
    VIS_MUTATE_SET_GRAVITY_IF,
